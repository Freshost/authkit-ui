...
export const en = {
  ...
  adminLogins: {
    title: 'User sign-ins',
    cardTitle: 'Recent user sign-ins',
    description: 'Successful sign-ins across all users in this authentication domain.',
    empty: 'No sign-ins recorded yet.',
    emptyDescription: 'Successful password and remember-me sign-ins will appear here.',
    noResults: 'No sign-ins match these filters.',
    noResultsDescription: 'Change or clear one or more filters and try again.',
    userLabel: 'User',
    whenLabel: 'Date and time',
    methodLabel: 'Method',
    ipLabel: 'IP address',
    unknownIp: 'Unknown',
    error: 'Could not load user sign-ins.',
    total: '{{count}} total',
    viewAll: 'View all sign-ins',
    clearFilters: 'Clear all filters',
    sortByDate: 'Sort by date and time',
    attributeMenuLabel: 'Select a sign-in filter',
    userSearchLabel: 'Filter by user',
    userSearchPlaceholder: 'Filter by name or email',
    ipSearchLabel: 'Filter by IP address',
    ipSearchPlaceholder: 'Filter by IP address',
    methodPlaceholder: 'Filter by method',
    methodMenuLabel: 'Filter by sign-in method',
  },
  sessions: {
