...
export const en = {
  ...
  adminLogins: {
    ...
    searchLabel: 'Filter user sign-ins',
    searchPlaceholder: 'Try user:Jane, ip:203.0.113 or method:password',
    openFilters: 'Open sign-in filters',
    applyFilters: 'Apply filters',
    clearFilters: 'Clear all filters',
    sortByDate: 'Sort by date and time',
    invalidMethodFilter: 'Method must be password or remember.',
  },
  sessions: {
